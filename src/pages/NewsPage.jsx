  ...
  const articles = [
    {
      ...
      category: "featured",
      date: "2024-12-20",
      excerpt: "Hành trình 8 năm xây dựng thương hiệu đồng phục chất lượng cao, mang đến giá trị tốt nhất cho khách hàng."
    },
    {
      id: 2,
      ...
      category: "featured",
      date: "2024-12-15",
      excerpt: "Những thiết kế logo độc đáo, sáng tạo dành riêng cho các lớp chuyên toán, thể hiện đam mê và tài năng."
    },
    {
      id: 3,
      ...
      date: "2024-12-10",
      excerpt: "Khám phá những mẫu áo lớp với kiểu dáng hiện đại, chất liệu cao cấp, phù hợp với mọi phong cách."
    },
    {
      id: 4,
      ...
      category: "featured",
      date: "2024-12-05",
      excerpt: "Chặng đường phát triển với những thành tựu ấn tượng và sự tin tưởng từ hàng ngàn khách hàng."
    },
    {
      id: 5,
      ...
      category: "new-product",
      date: "2024-12-01",
      excerpt: "Top các slogan hay, ý nghĩa giúp lớp bạn nổi bật và để lại ấn tượng khó quên."
    },
    {
      id: 6,
      ...
      category: "new-product",
      date: "2024-11-28",
      excerpt: "Thiết kế áo lớp đặc biệt cho giáo viên, kết hợp giữa sự lịch lãm và tính đồng đội."
    },
  ];
