...
import { FiPlus, FiTrash2, FiDownload, FiUpload, FiShoppingCart } from "react-icons/fi";
...
function BulkOrder() {
  ...
  const calculateDiscount = (quantity) => {
    ...
    if (quantity >= 30) return 0.10; // 10% off
  ...
  const getTotalQuantity = () => {
    return orderItems.reduce((sum, item) => sum + (parseInt(item.quantity) || 0), 0);
  };
  ...
  const handleDownloadTemplate = () => {
    const csvContent = "STT,Họ và Tên,Size,Số Lượng\n1,Nguyễn Văn A,M,1\n2,Trần Thị B,L,1";
  ...
  const handleSubmit = (e) => {
    ...
    alert("Đơn hàng đã được gửi thành công! Chúng tôi sẽ liên hệ với bạn sớm nhất.");
                      ...
                      {selectedProduct && (
                        <div className="product-preview">
                          ...
                          <div className="product-info">
                            ...
                            <p className="price">{formatPrice(selectedProduct.price)}/sản phẩm</p>
                  ...
                  <div className="card">
                      ...
                      <div className="upload-section">
                        ...
                        <div className="upload-area">
                          ...
                          <label htmlFor="file-upload" className="upload-label">
                            ...
                            <small>Định dạng: STT, Họ và Tên, Size, Số Lượng</small>
                          </label>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="size-summary">
                      ...
                      <div className="size-tags">
                        {Object.entries(getSizeSummary()).map(([size, count]) => (
                      ...
                      <div className="form-row">
                        <div className="form-group">
                          ...
                          <input
                            ...
                            onChange={(e) => handleContactChange("className", e.target.value)}
                            placeholder="VD: 12A1"
                            required
                          />
                        </div>
                        <div className="form-group">
                          ...
                          <input
                            ...
                            onChange={(e) => handleContactChange("schoolName", e.target.value)}
                ...
                <div className="order-summary">
                  <div className="summary-card sticky">
                    ...
                    <div className="summary-row">
                      ...
                      <strong className="highlight">{getTotalQuantity()} sản phẩm</strong>
                    </div>
                    ...
                    {getDiscount() > 0 && (
                      <>
                        <div className="summary-row discount">
                          <span>
                            Giảm giá ({(calculateDiscount(getTotalQuantity()) * 100).toFixed(0)}%):
                          </span>
                          <span className="discount-amount">-{formatPrice(getDiscount())}</span>
                        </div>
                        <div className="discount-note">
                          🎉 Bạn đã được giảm giá {(calculateDiscount(getTotalQuantity()) * 100).toFixed(0)}%
                        </div>
                      </>
                    )}
                    ...
                    <div className="summary-row total">
                      <span>Tổng cộng:</span>
                      <strong className="total-amount">{formatPrice(getTotal())}</strong>
                    </div>
